...
from util.dsgg.box_ops import box_iou, box_cxcywh_to_xyxy
import pdb

class BasicSceneGraphEvaluator:
    def __init__(self, args, mode, iou_threshold=0.5, model_version="", save_file="tmp", constraint=False, semithreshold=None, error_analysis=False, nms_filter=False):
        self.result_dict = {}
        self.mode = mode
        self.num_rel = 26
        self.num_attn = 3
        ...
        with open(self.save_file, "w") as f:
            f.write(f"Begin testing with pretrained: {model_version}\n")
            f.write(f"{args}\n")
    ...
    def print_stats(self):
        ...
        with open(self.save_file, "a") as f:
            f.write('======================' + f'constraint: {self.constraint}|' + self.mode + '============================\n')
            print('======================' + f'constraint: {self.constraint}|' + self.mode + '============================')
