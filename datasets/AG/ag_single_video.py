...
def build(image_set, args):
    ...
    dataset = AGSingleVideoDataset(img_folder, anno_file, transforms=make_coco_transforms(image_set, args.image_size), cache_mode=args.cache_mode, local_rank=get_local_rank(), local_size=get_local_size(), is_train=(not args.eval))
